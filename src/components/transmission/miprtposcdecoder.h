...
/**
 * \file miprtposcdecoder.h
 */

#ifndef MIPRTPOSCDECODER_H

#define MIPRTPOSCDECODER_H

#include "mipconfig.h"
#include "miprtppacketdecoder.h"

/** Decodes incoming RTP data into OSCMessages.
 *  This class takes MIPRTPReceiveMessages as input and generates
 *  OSC messages.
 */
class EMIPLIB_IMPORTEXPORT MIPRTPOSCDecoder : public MIPRTPPacketDecoder
{
public:
	MIPRTPOSCDecoder();
	~MIPRTPOSCDecoder();
